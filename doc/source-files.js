...
sourcesIndex["chalk"] = {"name":"","dirs":[{"name":"coherence","dirs":[],"files":["orphan.rs","solve.rs"]},{"name":"rules","dirs":[],"files":["default.rs","wf.rs"]},{"name":"rust_ir","dirs":[],"files":["lowering.rs"]}],"files":["coherence.rs","db.rs","errors.rs","lib.rs","query.rs","rules.rs","rust_ir.rs"]};
sourcesIndex["chalk_engine"] = {"name":"","dirs":[{"name":"context","dirs":[],"files":["prelude.rs"]}],"files":["context.rs","derived.rs","fallible.rs","forest.rs","hh.rs","lib.rs","logic.rs","simplify.rs","stack.rs","strand.rs","table.rs","tables.rs"]};
sourcesIndex["chalk_ir"] = {"name":"","dirs":[{"name":"fold","dirs":[],"files":["shift.rs","subst.rs"]}],"files":["cast.rs","could_match.rs","debug.rs","fold.rs","lib.rs","macros.rs","tls.rs","zip.rs"]};
sourcesIndex["chalk_macros"] = {"name":"","dirs":[],"files":["index.rs","lib.rs"]};
sourcesIndex["chalk_parse"] = {"name":"","dirs":[],"files":["ast.rs","errors.rs","lib.rs"]};
sourcesIndex["chalk_solve"] = {"name":"","dirs":[{"name":"infer","dirs":[],"files":["canonicalize.rs","instantiate.rs","invert.rs","normalize_deep.rs","ucanonicalize.rs","unify.rs","var.rs"]},{"name":"solve","dirs":[{"name":"slg","dirs":[{"name":"implementation","dirs":[],"files":["aggregate.rs","resolvent.rs"]}],"files":["implementation.rs"]}],"files":["slg.rs","truncate.rs"]}],"files":["ext.rs","infer.rs","lib.rs","solve.rs"]};
sourcesIndex["chalki"] = {"name":"","dirs":[],"files":["chalki.rs"]};
sourcesIndex["derive_new"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["diff"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["docopt"] = {"name":"","dirs":[],"files":["dopt.rs","lib.rs","parse.rs","synonym.rs"]};
sourcesIndex["either"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["ena"] = {"name":"","dirs":[{"name":"unify","dirs":[],"files":["backing_vec.rs","mod.rs"]}],"files":["lib.rs","snapshot_vec.rs"]};
...
sourcesIndex["lalrpop_intern"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["lalrpop_util"] = {"name":"","dirs":[],"files":["lib.rs"]};
...
sourcesIndex["stacker"] = {"name":"","dirs":[],"files":["lib.rs"]};
